...
export const MOCK_MISTAKES: Mistake[] = [
  {
    ...
    evDiff: -3.42,
    category: "Push/Fold",
    hand: ["2m","3m","4m","6m","7m","2p","3p","0p","6p","7p","4s","0s","7z"],
    drew: "7z",
    yourDiscard: "0p",
    optimalDiscard: "7z",
    boardState: {
  ...
  },
  {
    ...
    evDiff: -2.87,
    category: "Efficiency",
    hand: ["1m","2m","3m","0m","5m","3p","4p","7p","8p","3s","4s","0s","6s"],
    drew: "6p",
    yourDiscard: "6s",
    optimalDiscard: "0m",
    boardState: {
  ...
  },
  {
    ...
    boardState: {
      ...
      kamicha: { seat: "East", score: 20800, discards: ["3z","6z","9m","1z","5z","2z","7z","4z","1p","0m"], closedHandCount: 13, isDealer: true, isRiichi: false, openMelds: [] },
